    ...
    public class MusicPlayer : BaseElement
    {
      ...
      roundedTrackBar1 = new SoundTrackBar.RoundedTrackBar(cont);
        ...
        BackColor = Color.Black;
            ...
            //   this.roundedTrackBar1 = new SoundTrackBar.RoundedTrackBar(cont);
            //    this.playBtn1 = new buttonPlay.PlayBtn();
            //  this.prevBtn1 = new buttonPlay.PrevBtn();
            //  this.volumeTrackBar1 = new SoundTrackBar.VolumeTrackBar(cont);
            //  this.musicTrackBar1 = new SoundTrackBar.MusicTrackBar(cont);
